(module
  ...
  (import "wasi_snapshot_preview1" "fd_read" (func $__wasi_fd_read (type 2)))
  (import "wasi_snapshot_preview1" "proc_exit" (func $__wasi_proc_exit (type 3)))
  (import "wasi_snapshot_preview1" "fd_write" (func $__wasi_fd_write (type 2)))
  (import "env" "__syscall_connect" (func $__syscall_connect (type 5)))
  ...
  (func $__emscripten_stdout_seek (type 8) (param i32 i64 i32) (result i64)
    i64.const 0)
  (func $memset (type 4) (param i32 i32 i32)
    local.get 2
    if  ;; label = @1
      loop  ;; label = @2
        local.get 0
  ...
  (func $__towrite (type 0) (param i32) (result i32)
    ...
    i32.store offset=16
    i32.const 0)
  (func $wctomb (type 9) (param i32 i32) (result i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      i32.const 0
  ...
  (func $printf_core (type 2) (param i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 12)
  (func $out (type 4) (param i32 i32 i32)
  ...
  (func $getint (type 0) (param i32) (result i32)
    ...
    local.get 2)
  (func $pop_arg (type 4) (param i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
  ...
  (data $.rodata (i32.const 1024) "-+   0X0x\00www.baidu.com\00(null)\00Message form server: %s\0a")
  (data $.rodata.1 (i32.const 1088) "\19\00\0a\00\19\19\19\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\19\00\11\0a\19\19\19\03\0a\07\00\01\00\09\0b\18\00\00\09\06\0b\00\00\0b\00\06\19\00\00\00\19\19\19")
  (data $.rodata.2 (i32.const 1169) "\0e\00\00\00\00\00\00\00\00\19\00\0a\0d\19\19\19\00\0d\00\00\02\00\09\0e\00\00\00\09\00\0e\00\00\0e")
  (data $.rodata.3 (i32.const 1227) "\0c")
  (data $.rodata.4 (i32.const 1239) "\13\00\00\00\00\13\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data $.rodata.5 (i32.const 1285) "\10")
  (data $.rodata.6 (i32.const 1297) "\0f\00\00\00\04\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10")
  (data $.rodata.7 (i32.const 1343) "\12")
  (data $.rodata.8 (i32.const 1355) "\11\00\00\00\00\11\00\00\00\00\09\12\00\00\00\00\00\12\00\00\12\00\00\1a\00\00\00\1a\1a\1a")
  (data $.rodata.9 (i32.const 1410) "\1a\00\00\00\1a\1a\1a\00\00\00\00\00\00\09")
  (data $.rodata.10 (i32.const 1459) "\14")
  (data $.rodata.11 (i32.const 1471) "\17\00\00\00\00\17\00\00\00\00\09\14\00\00\00\00\00\14\00\00\14")
  (data $.rodata.12 (i32.const 1517) "\16")
  (data $.rodata.13 (i32.const 1529) "\15\00\00\00\00\15\00\00\00\00\09\16\00\00\00\00\00\16\00\00\16\00\000123456789ABCDEF")
  (data $.data (i32.const 1568) "\05")
  (data $.data.1 (i32.const 1580) "\02")
  (data $.data.2 (i32.const 1604) "\03\00\00\00\04\00\00\00\d8\06\00\00\00\04")
  (data $.data.3 (i32.const 1628) "\01")
  (data $.data.4 (i32.const 1644) "\ff\ff\ff\ff\0a")
  (data $.data.5 (i32.const 1712) " \06"))
